...
const translations = {
    en: {
        nav: { brand: 'Phuquymermaids', home: 'Home', about: 'About', tours: 'Tours', gallery: 'Gallery', contact: 'Contact' },
        hero: { title: 'Dive Into Freedom', subtitle: 'Experience the breathtaking beauty of Phú Quý Island through freediving', cta: 'Book Your Adventure', scroll: 'Scroll Down' },
        about: {
            title: 'About Phuquymermaids',
            subtitle: 'Your gateway to underwater exploration',
            heading: 'Discover the Depths',
            p1: 'Phuquymermaids offers professional freediving experiences in the pristine waters surrounding Phú Quý Island. Our expert instructors guide you through the art of freediving, allowing you to connect with the ocean in its purest form.',
            p2: "Whether you're a beginner or an experienced freediver, we provide personalized tours that showcase the island's vibrant marine life, crystal-clear waters, and stunning underwater landscapes.",
            f1: { title: 'Expert Instructors', desc: 'Certified professionals with years of experience' },
            f2: { title: 'Safety First', desc: 'Comprehensive safety protocols and equipment' },
            f3: { title: 'Small Groups', desc: 'Personalized attention for every participant' },
            f4: { title: 'Beautiful Locations', desc: 'Carefully selected dive sites around Phú Quý' }
        },
        tours: {
            title: 'Our Packages',
        ...
        included: {
            ...
            i1Desc: 'Professional instructor guiding you throughout the entire dive. Our Phu Quy Mermaids team holds international freediving certifications.',
        ...
        gallery: { title: 'Diving Moments', subtitle: 'Photos from our guests and freediving experiences at Phú Quý' },
        contact: {
        ...
        footer: {
            ...
            tagline: 'Your trusted partner for freediving adventures in Phú Quý Island.',
    ...
    vi: {
        nav: { brand: 'Phuquymermaids', home: 'Trang chủ', about: 'Giới thiệu', tours: 'Tour', gallery: 'Ảnh lặn', contact: 'Liên hệ' },
        hero: { title: 'Lặn Tự Do', subtitle: 'Trải nghiệm vẻ đẹp tuyệt vời đảo Phú Quý qua môn lặn freediving', cta: 'Đặt tour ngay', scroll: 'Cuộn xuống' },
        about: {
            title: 'Về Phuquymermaids',
            subtitle: 'Cửa ngõ khám phá thế giới dưới biển',
            heading: 'Khám phá đại dương',
            p1: 'Phuquymermaids mang đến trải nghiệm lặn freediving chuyên nghiệp tại vùng biển trong xanh quanh đảo Phú Quý. Hướng dẫn viên giàu kinh nghiệm sẽ đồng hành cùng bạn trong hành trình kết nối với đại dương.',
            p2: 'Dù bạn mới bắt đầu hay đã có kinh nghiệm, chúng tôi tổ chức tour riêng phù hợp, giới thiệu hệ sinh thái biển phong phú, làn nước trong vắt và cảnh quan dưới nước tuyệt đẹp của đảo.',
            f1: { title: 'Hướng dẫn viên chuyên nghiệp', desc: 'Chứng chỉ quốc tế, nhiều năm kinh nghiệm' },
            f2: { title: 'An toàn hàng đầu', desc: 'Quy trình an toàn và trang thiết bị đầy đủ' },
            f3: { title: 'Nhóm nhỏ', desc: 'Chăm sóc từng thành viên tận tình' },
            f4: { title: 'Điểm lặn đẹp', desc: 'Địa điểm lặn được chọn lọc quanh Phú Quý' }
        },
        tours: {
        ...
        included: {
            ...
            i1Desc: 'Đội ngũ HDV của Phu Quy Mermaids có chứng chỉ lặn quốc tế, đồng hành suốt quá trình lặn.',
        ...
        gallery: { title: 'Ảnh lặn', subtitle: 'Ảnh từ khách và trải nghiệm freediving tại Phú Quý' },
        contact: {
            title: 'Đặt tour',
        ...
        footer: {
            ...
            quickLinks: 'Liên kết',
            follow: 'Theo dõi',
            moreMedia: 'Bạn có thể tham khảo thêm video/hình ảnh trên trang của tụi mình tại:',
            igLabel: 'Instagram',
            tiktokLabel: 'Tiktok',
...
const savedLang = (typeof localStorage !== 'undefined' && localStorage.getItem(LANG_KEY)) || 'en';
...
const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxWxLV9zpkT4RymF2IyxskOHpT4ue1qDK2Br5BeLcIMaMJ1xgxonSp8XzLso9KBZJk/exec';
const GOOGLE_SCRIPT_ID = 'AKfycbxWxLV9zpkT4RymF2IyxskOHpT4ue1qDK2Br5BeLcIMaMJ1xgxonSp8XzLso9KBZJk';
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        const msg = (translations[lang] && translations[lang].formSuccess) || translations.en.formSuccess;
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.tour-card, .feature-item, .about-text, .gallery-item, .included-card, .itinerary-card');
